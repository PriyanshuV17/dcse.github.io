                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="card shadow rounded">
                            <h5 class="fw-bold bg-primary p-2 ps-4 mb-0 rounded">Committee</h5>
                            ...
                            <div class=" table-responsive">
                              <table class="table table-striped" style="width:100%">
                                ...
                                <tbody>
                                    <tr>
										<td></td>
                                        <td>Departmental Research Committee (DRC)</td>
                                        <td>
											<a href="files/New-DRC-Notification.pdf" target="_blank">
                                    ...
                                    <tr>
										<td></td>
                                    	<td>Board of Studies (BOS)</td>
                                    	<td>
											<a href="files/BOSN.pdf" target="_blank">
                                                <i class="fa fa-external-link-square" aria-hidden="true"></i>
											</a>
										</td>
                                    </tr>
