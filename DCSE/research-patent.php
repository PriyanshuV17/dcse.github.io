		        ...
		        <div class="container">
		            <div class="row">
		                <div class="col-md-12 text-center">
		                    <h1 class="page-title">Research-patent</h1>
		                </div>
		            </div>
		        </div>
		    </div>
        ...
        <div class="slider1-area index1 p-4">
            ...
            <div class="container-fluid">
				...
				<div class="col-md-3">
                    ...
                    <div class="col-md-9">
                        <div class="card shadow rounded">
                            <h5 class="fw-bold bg-primary p-2 ps-4 mb-0 rounded">Patents published / Awarded during the year
                            </h5>
                            <div class="table-responsive">
                                <h6 class="mb-0 p-2">DETAILS OF  PATENT</h6>
                                <table class="table table-striped" style="width: 100%;">
                                    <thead class="table-secondary" >
                                       <tr>
                                           <th>Name of the Patent Published/Awarded</th>
                                           <th class="text-center">Patent Number</th>
										   <th class="text-center">Inventors</th>
                                           <th class="text-center">Year of Award</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <td> “METHOD AND SYSTEM FOR CONNECTING USERS DURING A GROUP TRAVEL”</td>
                                            <td class="text-center">383269</td>
                                            <td class="text-center">Dr. Prashant Prashun</td>
											<td class="text-center">30/11/2021</td>
                                        </tr> 
                                        <tr>
                                            <td>“An IOT based Smart Gas Monitoring and Controlling System”</td>
                                            <td class="text-center">202231009348A</td>
                                            <td class="text-center">Dr. Kanojia Sindhuben Babulal </td>
											<td class="text-center">11/03/2022</td>
                                        </tr>
                                        <tr>
                                            <td>“METHOD AND DEVICE FOR ACCESSING APPLICATIONS”</td>
                                            <td class="text-center">3140/DEL/2014</td>
                                            <td class="text-center">Dr. Prashant Prashun</td>
											<td class="text-center">16/01/2020</td>
                                        </tr>
                                        <tr>
                                            <td>“METHOD AND SYSTEM FOR MODIFYING USER-BEHAVIOUR”</td>
                                            <td class="text-center">2640/DEL/2014</td>
                                            <td class="text-center">Dr. Prashant Prashun</td>
