		        ...
		        <div class="container">
		            <div class="row">
		                <div class="col-md-12 text-center">
		                    <h1 class="page-title">Research-project</h1>
		                </div>
		            </div>
		        </div>
		    </div>
        ...
        <div class="slider1-area index1 p-4">
            ...
            <div class="container-fluid">
				...
				<div class="col-md-3">
                    ...
                    <div class="col-md-9">
                        <div class="card shadow rounded">
                            <h5 class="fw-bold bg-primary p-2 ps-4 mb-0 rounded">Extramural funding for Research
                            </h5>
                            <div class=" table table-striped">
                                <h6 class="mb-0 p-2">EXTRAMURAL FUNDING FOR RESEARCH</h6>
                                <table class="table table-striped" style="width: 100%;">
                                    <thead class="table-secondary" >
                                       <tr>
                                           <th>Name of the Project/ Endowments, Chairs</th>
                                           <th>Name of the Principal Investigator</th>
                            ...
                            <div class="table-responsive">
                                <h6 class="mb-0 p-2">DETAILS OF  RESEARCH PROJECT</h6>
                                <table class="table table-striped" style="width: 100%;">
                                    <thead class="table-secondary" >
                                       <tr>
                                           ...
                                           <th>Amount/Fund received</th>
                                           <th>Name of the funding agency</th>
                                           <th>Year of Sanction</th>
                                           <th>Year of Completion/ongoing</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                            ...
                            <div class="table-responsive">
                                <h6 class="mb-0 p-2">DETAILS OF  CONSULTANCY PROJECT</h6>
                                <table class="table table-bordered" style="width: 100%;">
                                    <thead class="table-secondary" >
                                       <tr>
                                           ...
                                           <th>Total revenue generated in rupees</th>
                                           <th>Details of corporate training provided (Title of training, corporate for which training has been provided, number of participant)</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
