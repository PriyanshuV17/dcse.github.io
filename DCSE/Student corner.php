                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <div class="card shadow rounded">
                            <h5 class="fw-bold bg-primary p-2 ps-4 mb-0 rounded">Students Corner 
                            </h5>
                            <div class=" table table-striped">
								<table class="table table-striped" style="width: 100%;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td></td>
                                            <td>Samarth Student Portal</td>
                                            <td>
												<a href="https://cuj.samarth.edu.in/index.php/site/login" target="_blank">
													https://cuj.samarth.edu.in/index.php/site/login
												</a>
											</td>
                                        </tr>
										...
										<tr>
                                            <td></td>
                                            <td>Samarth Employee Portal</td>
                                            <td>
												<a href="https://cuj.samarth.ac.in/index.php/site/login" target="_blank">
													https://cuj.samarth.ac.in/index.php/site/login
												</a>
											</td>
                                        </tr> 
                                ...
                                <table class="table table-striped" style="width: 100%;">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td >
                                            <a href="#" target="_blank">
                                            <i class="fa fa-external-link-square" aria-hidden="true"></i>                                            </a></td>
						...
						<!--
			<div class="card shadow rounded">
                            <h5 class="fw-bold bg-primary p-2 ps-4 mb-0 rounded">Pass out batch 
                            </h5>
                            <div class=" table table-striped">
