		        ...
		        <div class="container">
		            <div class="row">
		                <div class="col-md-12 text-center">
		                    <h1 class="page-title">E-Content</h1>
		                </div>
		            </div>
		        </div>
		    </div>
				...
				<div class="col-md-3">
                            ...
                            <nav class="navigation">
								...
								<li class="list-group-item"><h6 class="mb-0"><a class="" href="CS&Edepartment.php"><i class="fa fa-home"></i> Home</a></h6></li>
                                    ...
                                    <li class="list-group-item"><h6 class="mb-0"><a href="#"><span class='bi bi-lightbulb-fill'></span> Research <span class='bi bi-chevron-down' style="float:right;"></span></a></h6>
									 ...
									 <li class="list-group-item"><h6 class="mb-0"><a href="all-profiles.php"><span class='bi bi-people-fill'></span> DCSE Faculty & Staffs</a></li>
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="card shadow-lg rounded">
                            <h2 class="fw-bold bg-primary p-2 ps-4 mb-0 rounded">DETAILS OF E-CONTENT DEVELOPED BY TEACHERS</h2>
                            <table id="admissionTable" class="table table-striped mb-0" style="width:100%">
                                <thead>
                                    <tr>
										...
										<th>Number of platforms on which e-content has been developed by teachers</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
