        ...
        <div class="slider1-area index1 p-4">			
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <div class="card shadow rounded" style="font-size: 18px;">
                            <h5 class="fw-bold bg-primary p-2 ps-4 mb-0 rounded">Contact Us</h5>
                            <div class="p-4 justify-text-center">
								<div class="col-md-12" style="text-align: center;">
									<div class="instructor-inner">
										<div class="instructor-body">
											<span>Department of Computer Science and Engineering</span><br>
											<span>Central University of Jharkhand </span><br>
											<span><i class="fa fa-map-marker">&nbsp;</i>
												Ratu-Lohardaga Road
												Brambe, Ranchi,
												Jharkhand, India - 835 205</span><br>
											<span><i class="fa fa-envelope">&nbsp;</i>
												<a href="mailto:dcse.office@cuj.ac.in">dcse.office@cuj.ac.in</a>
											</span>
										</div>
									</div>
								</div>
